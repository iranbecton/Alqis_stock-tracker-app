...
export function StockHeroHeader({
  ...
  return (
    <header className="grid gap-4 border-b border-border/60 pb-4 xl:grid-cols-[minmax(0,1fr)_23.5rem] xl:gap-6 xl:items-start">
      <div className="space-y-3.5">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="text-body-sm text-ink-subtle">{company.statusDetail}</span>
        </div>

        <div className="space-y-2">
          <div>
            <p className="section-kicker">{company.symbol}</p>
            <h1 className="text-page-title font-serif text-ink">{company.name}</h1>
          </div>
          <p className="reading-width text-body-lg text-ink-muted">{company.oneLineSummary}</p>

          <div className="flex flex-wrap gap-x-5 gap-y-1.5 text-body-sm text-ink-subtle">
      ...
      <div className="flex flex-col gap-2 xl:items-end">
        ...
        <div className="w-full rounded-[var(--radius-xl)] border border-border/70 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--surface-elevated)_86%,var(--accent-ai)_8%)_0%,color-mix(in_srgb,var(--surface)_94%,var(--accent-secondary)_6%)_100%)] px-5 py-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.02),0_16px_38px_rgba(2,6,10,0.14)] xl:w-[23rem]">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <div className="mt-1.5 flex flex-wrap items-end gap-3">
                <span className="text-5xl font-semibold tracking-tight text-ink" data-numeric>
                  {company.price}
                </span>
                <Delta
            ...
            <div className="rounded-[var(--radius-md)] border border-border/60 bg-surface/35 px-3 py-2 text-right">
          ...
          <div className="mt-3.5 grid grid-cols-2 gap-3 text-body-sm">
